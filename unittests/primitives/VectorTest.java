...
class VectorTest {
    ...
    void testCrossProduct() {
        ...
        assertThrows(IllegalArgumentException.class, () -> v2.crossProduct(v6), "did not constructed a zero vector");
        assertEquals(v0,v6.crossProduct(v5),"Wrong result for CrossProduct function");
    ...
    void testSubtract() {
        ...
        assertEquals(new Vector(-4.0,2.0,3.0), v1.subtract(v6), "Subtract two points does not work correctly");

        // ============ Boundary Values Tests ==================
        // TC02: Subtract equal points
        assertThrows(IllegalArgumentException.class, () -> v1.subtract(v1), "Subtract equal points does not work correctly");
    }
}